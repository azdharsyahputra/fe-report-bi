      ...
      <div className="glass-card relative z-10 w-full max-w-md rounded-2xl p-8 sm:p-10">
        ...
        <div className="animate-fade-in-up mb-8 text-center">
          <img
            ...
            alt="Cashplus Logo"
            className="mx-auto mb-5 h-16 w-16 rounded-2xl object-contain shadow-[0_4px_16px_rgba(37,99,235,0.3)]"
          />
        ...
        {error && (
          <div className="error-message mb-6" role="alert">
            <div className="flex shrink-0 items-center justify-center rounded-full bg-red-100 p-1 text-red-600">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
